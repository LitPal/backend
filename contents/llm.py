...
class LLM:
    ...
    def __init__(self, url: str) -> None:
        ...
        self.llm1 = OpenAI(openai_api_key="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") 
    ...
    def qa(self, file, query, chain_type, k):
        # load document
        ...
        embeddings = OpenAIEmbeddings(openai_api_key="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") # "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")
    ...
    def query(self, question: str):
        result = self.qa(file=self.pdf, query=question, chain_type='map_reduce', k=1)
        return result
